...
abstract class AppLogger {
  ///LOGGERS
  static const _general = 'TRUEME_LOG';
  ...
  static void database(
    ...
    if (F.isDev) {
      Logger.root.info('[$_database] $message', error, stackTrace);
    }
  }
  ...
  static void wtf(dynamic message, [dynamic error, StackTrace? stackTrace]) {
    if (F.isDev) {
      Logger.root.info('⁉️😂️ [$_general] $message', error, stackTrace);
    }
  }
